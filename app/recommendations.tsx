...
const PICKS_BY_USAGE: Record<string, CarRecommendation[]> = {
  ...
  cheap_car: [
    ...
    },
    {
      id: "ka-mk2",
      make: "Ford", model: "Ka",
      yearRange: "2009 – 2016", yearFrom: 2009, yearTo: 2016,
      bodyTypes: ["hatchback"],
      runningCost: "low", priceBand: "budget",
      rationale: "Sub-£2k examples are plentiful — the 1.2 Duratec is mechanically straightforward, insurance is group 1–4, and parts are everywhere.",
      tags: ["Insurance group 1-4", "Simple 1.2 Duratec", "Sub-£2k options", "Watch: rust on sills and arches"],
    },
    {
      id: "picanto-mk2",
    ...
    },
    {
      ...
      yearRange: "2010 – 2016", yearFrom: 2010, yearTo: 2016,
      bodyTypes: ["hatchback"],
      runningCost: "low", priceBand: "budget",
      rationale: "Exceptionally reliable 1.2 petrol with very few known faults — zero road tax examples are easy to find, and parts are inexpensive and widely available.",
      tags: ["Zero road tax options", "Reliable 1.2", "Low insurance", "Watch: clutch wear on urban examples"],
    },
    {
      id: "clio-mk3",
